				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						...
						<div class="form-group">
								...
								<div class="col-sm-9">
									 		<form:textarea path="thumbnail" rows="5" cols="10" cssClass="form-control" id="thumbnail"/>
								</div>
						</div>
						<div class="form-group">
						  	<label for="shortDescription" class="col-sm-3 control-label no-padding-right">Code thể loại:</label>
						  	<div class="col-sm-9">
						  		<form:textarea path="code" rows="5" cols="10" cssClass="form-control" id="code"/>
						  	</div>
						</div>
