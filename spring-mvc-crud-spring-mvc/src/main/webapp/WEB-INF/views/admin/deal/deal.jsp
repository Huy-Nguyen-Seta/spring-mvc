...
<c:url var="newURL" value="/quan-tri/deal"/>
...
<html>
	...
	<c:forEach var="item" items="${model.listResult}">
		...
		<form action="<c:url value='/quan-tri/deal'/>" id="formSubmit" method="get">
			
				<div class="main-content-inner" style="border-color: lightblue;border-width: 3px;border-style: solid">
	...
	<a>	<img  src="<c:url value='/template/Picture1.png' />" style="height: 120px;width: 120px;position: absolute;left: 270px;top:95px"></img></a>
			...
			<ul class="pagination" id="pagination"></ul>	
											...
											<button onclick="accept(${item.id})" style="height: 40px;left: 900px;border-color: rgb(80, 199, 193);position: relative;width: 160px;top: -40px">Xác nhận đơn hàng</button>
