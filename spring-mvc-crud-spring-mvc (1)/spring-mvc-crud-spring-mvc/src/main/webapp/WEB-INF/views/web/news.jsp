					...
					<form>
						<div class="form-row" >
							<div class="form-group col-md-4">
								<input style="background: #212529;color: white;border-color: white" type="text" class="form-control my-2 my-lg-0" id="inputtext4" placeholder="What are you looking for">
							</div>
							<div class="form-group col-md-3">
								<input style="background: #212529;color: white;border-color: white" type="text" class="form-control my-2 my-lg-0" id="inputCategory4" placeholder="Category">
							</div>
							<div class="form-group col-md-3">
								<input style="background: #212529;color: white;border-color: white" type="text" class="form-control my-2 my-lg-0" id="inputLocation4" placeholder="Location">
							</div>
							<div class="form-group col-md-2">
								
								<button type="submit" class="" style="background: #212529;border-color: white;height: 50px;color: white">Search Now</button>
							</div>
						</div>
					</form>
				</div>
			 ...
			 <div class="product-f-image">
				<img class="card-img-top img-fluid" src="${item.thumbnail }" style="height: 250px" alt="Card image cap">
				  <div class="product-hover">
                                        <a onclick="clickduavaogiohang('${item.id}','${item.thumbnail}','1','${item.title}')"  class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
...
<ul class="pagination" id="pagination" style="height: 30px;position: absolute;left: 600px;top: 1560px"></ul>	
